...
const QuestionBox = ({
  ...
  return (
    <div className="p-6 bg-blue-500 rounded-xl text-black font-modern text-lg w-full max-w-xl shadow-lg text-center animate-fade-in">
      <div className="mb-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        {options.map((option, index) => (
          <button
            ...
            className="px-4 py-2 bg-[#FFCF40] hover:bg-[#FEBC33] text-black font-game text-lg rounded-lg shadow-md animate-bounce-in"
            disabled={isTimeUp}
          >
            {option}
          </button>
